...
import com.pluralsight.util.ServerError;
...
public class RideController {
	...
	public ResponseEntity<ServerError> handle(RuntimeException ex){
		ServerError error = new ServerError(HttpStatus.OK.value(), ex.getMessage());
